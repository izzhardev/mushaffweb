    ...
    <section className="py-24 bg-slate-50 relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="text-center mb-16">
          ...
          <h2 className="text-4xl font-bold text-slate-900 mb-4">Salurkan Kebaikan Anda</h2>
            ...
            return (
              ...
              >
                ...
                <div className="p-8 flex flex-col flex-grow">
                  <h3 className="text-xl font-bold text-slate-900 mb-6 group-hover:text-primary transition-colors line-clamp-2 min-h-[3.5rem]">
                    {campaign.title}
                  </h3>
                  
                  <div className="space-y-4 mb-8">
                    <div className="flex justify-between text-sm font-bold mb-1">
                      <span className="text-primary">Terkumpul</span>
                    ...
                    <div className="flex justify-between items-end">
                      <div className="flex flex-col">
                        <span className="text-[10px] uppercase font-bold text-slate-400 tracking-wider">Terkumpul</span>
                        <span className="text-lg font-black text-slate-900">Rp {campaign.currentAmount?.toLocaleString() || 0}</span>
                      </div>
                  ...
                  <Link 
                    ...
                    className="mt-auto w-full bg-primary text-white py-4 rounded-2xl font-bold flex items-center justify-center gap-2 hover:bg-primary/90 transition-all shadow-lg shadow-primary/20 group/btn"
                  >
                    Donasi Sekarang
